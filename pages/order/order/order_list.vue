  ...
  <div>
    ...
    <div class="container padding_b_0">
      <div class="dflex_wrap">
        ...
        <div class="search_advanced margin_b_20" @click="advancedSearch = !advancedSearch" v-if="!advancedSearch"
          >高级筛选</div
        >
          ...
          <template slot-scope="scope">
            <div class="dflex_vertical_c">
              <el-image
                class="headimg_small"
                :src="
                  scope.row.order_member_headimg ||
    ...
    >
      <el-form class="add_edit" :model="expressForm" :rules="expressRules" ref="ruleForm" label-width="100px">
        ...
        <el-form-item>
          <el-button round icon="el-icon-check" class="confirm_btn" @click="submitExpressForm('ruleForm')"
            >提交</el-button
          >
    ...
    <el-drawer title="改价" :visible.sync="priceDrawer" direction="rtl" :append-to-body="true" :wrapperClosable="false">
      <el-form class="add_edit" :model="priceForm" :rules="priceRules" ref="ruleForm" label-width="100px">
        <el-form-item label="价格" prop="order_actural_paid" ref="order_actural_paid">
          <el-input
            v-model.number="priceForm.order_actural_paid"
            placeholder="请输入价格"
            type="number"
            min="0"
            clearable
        ...
        <el-form-item>
          <el-button round icon="el-icon-check" class="confirm_btn" @click="submitPriceForm('ruleForm')"
            >提交</el-button
          >
              ...
              if (res.code == 200) {
                ...
                this.$db[__log]
                  .add({
                    ...
                    remark:
                      '上次价格: ' +
                      this.orderData.order_actural_paid / 100 +
                      '元' +
                      ' 当前价格: ' +
                      this.priceForm.order_actural_paid / 100 +
                      '元',
              ...
              if (res.code == 200) {
                ...
                this.$db[__log]
                  .add({
                    ...
                    ip: this.user.last_login_ip,
                    remark:
                      '快递公司: ' + this.expressForm.order_express + ' 快递单号: ' + this.expressForm.order_express_no,
                    create_time: new Date().getTime(),
                    create_uid: this.user._id,
                    create_uname: this.user.username,
                  })
...
<style>
  ...
  .add_edit .el-input, .add_edit .el-textarea {
    width: 90%;
  }
</style>
