<template>
  <div class="container add_edit">
    <el-form :model="form" :rules="rules" ref="ruleForm" label-width="80px">
      <el-form-item label="页面名称" prop="name" ref="name"
      ...
      <el-form-item label="url地址" prop="url" ref="url"
        ><el-input v-model="form.url" placeholder="请输入地址"></el-input
      ></el-form-item>
      <el-form-item label="排序"
        ><el-input v-model.number="form.sort" type="number" min="0" placeholder="请输入排序"></el-input
      ></el-form-item>
