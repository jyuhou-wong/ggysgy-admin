<template>
  <div class="container add_edit">
    <el-form :model="form" :rules="rules" ref="ruleForm" label-width="100px">
      <el-form-item label="角色标识" prop="role_id" ref="role_id"
        ><el-input v-model="form.role_id" placeholder="请输入角色名称"></el-input
      ></el-form-item>
      <el-form-item label="角色名称" prop="role_name" ref="role_name"
