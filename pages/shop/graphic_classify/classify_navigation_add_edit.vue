  ...
  <div class="container add_edit">
    <el-form :model="form" :rules="rules" ref="ruleForm" label-width="100px">
      ...
      <el-form-item label="状态">
        <el-switch v-model="form.state" active-color="#feaa30" inactive-color="#bbb" active-value="启用" inactive-value="禁用"></el-switch>
      </el-form-item>
      <el-form-item>
...
export default {
  ...
  methods: {
    ...
    returnPage() {
      bus.$emit('tab-close')
      this.$router.push('/pages/shop/graphic_classify/classify_navigation')
    },
    urlChange(data) {
      console.log(data)
