        ...
        <div>
          ...
          <el-form-item label="编辑SKU" v-if="switch_sku">
            ...
            <div class="dflex margin_t_20">
              ...
              ></el-input>
              <el-button :disabled="!checked_spec" v-else class="button-new-tag" size="small" @click="showInput_spec"
                >添加</el-button
              >
            </div>
          </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      handleClose_spec(tag) {
        ...
        this.tableSkuData.splice(
          this.tableSkuData.findIndex((x) => x.spec == tag),
          1
        );
      },
      showInput_spec() {
