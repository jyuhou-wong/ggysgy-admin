  ...
  <div class="container add_edit">
    <el-form :model="form" ref="ruleForm" label-width="100px">
      <el-form-item label="用户名称"
        ><el-input v-model="form.member_name" placeholder="请输入名称"></el-input
      ></el-form-item>
      <el-form-item label="用户头像">
        <uni-file-picker
          v-model="imageValueUser"
          fileMediatype="image"
          returnType="object"
      ...
      <el-form-item label="订单号"
        ><el-input v-model="form.order_id" placeholder="请输入订单号"></el-input
      ></el-form-item>
      <el-form-item label="评论星数">
        <el-rate
          v-model="form.review_cnt"
          :colors="colors"
          class="margin_t_10"
          show-text
      ...
      <el-form-item label="评价内容"
        ><el-input type="textarea" :rows="3" v-model="form.review_content" placeholder="请输入内容"></el-input
      ></el-form-item>
      <el-form-item label="晒图">
        <uni-file-picker
          v-model="imageValueEvaluate"
          fileMediatype="image"
          returnType="array"
          :image-styles="imageStyle"
          @delete="imgDelete"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      imgDelete(e) {
        this.imageValueEvaluate.splice(
          this.imageValueEvaluate.findIndex((x) => x.url == e.url),
          1
        );
      },
      returnPage() {
