    ...
    <div class="container use-table">
      ...
      <el-table :height="tblHeight" :data="tableDatas" @selection-change="selectionChange" highlight-current-row>
        ...
        <el-table-column label="限时精选" align="center">
          <template slot-scope="scope">
            <el-tooltip
              :content="scope.row.limited == '1' ? '取消限时精选' : '启用限时精选'"
              placement="top"
              :hide-after="1000"
              :enterable="false"
              effect="light"
        ...
        <el-table-column label="热门推荐" align="center">
          <template slot-scope="scope">
            <el-tooltip
              :content="scope.row.hot == '1' ? '取消热门推荐' : '启用热门推荐'"
              placement="top"
              :hide-after="1000"
              :enterable="false"
              effect="light"
          ...
          <template slot-scope="scope">
            ...
            <div class="margin_t_10">
              <el-tooltip
                ...
                :enterable="false"
                effect="light"
                v-if="scope.row.state == '已下架' || scope.row.state == '待审核'"
              >
              ...
              <el-tooltip
                ...
                effect="light"
                v-if="scope.row.state == '销售中'"
                ><el-button icon="iconfont iconerweima" circle @click="qrCode"></el-button
              ></el-tooltip>
              <el-tooltip
                content="预览"
                placement="top"
