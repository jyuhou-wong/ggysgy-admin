            ...
            <div class="tag">
              ...
              <div>
                ...
                <v-countup
                  class="tag_data"
                  :start-value="start"
                  :end-value="member_sta.member_cnt"
                  :options="options"
                ></v-countup>
              </div>
            </div>
            <div class="tag">
              ...
              <div>
                ...
                <v-countup
                  class="tag_data"
                  :start-value="start"
                  :end-value="member_sta.member_cnt_7"
                  :options="options"
                ></v-countup>
              </div>
            </div>
            <div class="tag">
              ...
              <div>
                ...
                <v-countup
                  class="tag_data"
                  :start-value="start"
                  :end-value="member_sta.member_cnt_yesterday"
                  :options="options"
                ></v-countup>
              </div>
            </div>
            <div class="tag">
              ...
              <div>
                ...
                <v-countup
                  class="tag_data"
                  :start-value="start"
                  :end-value="member_sta.order_cnt"
                  :options="options"
                ></v-countup>
              </div>
            </div>
            ...
            <div class="tag">
              ...
              <div>
                ...
                <v-countup
                  class="tag_data"
                  :start-value="start"
                  :end-value="member_sta.pay_money"
                  :options="options"
                ></v-countup>
              </div>
            </div>
            ...
            <div class="dflex">
              ...
              <div>
                ...
                <v-countup
                  class="order_data"
                  :start-value="start"
                  :end-value="order_sta.pay_money / order_sta.pay_cnt"
                  :decimals="2"
            ...
            <div class="dflex">
              ...
              <div>
                ...
                <v-countup
                  class="order_data"
                  :start-value="start"
                  :end-value="order_sta.refund_cnt"
                  :options="options"
                ></v-countup>
              </div>
            </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      create_pie() {
        ...
        const category = {
          ...
          msg: '',
          datas: [
            { name: '冰箱', state: '销售中', cnt: 1 },
            { name: '微波炉', state: '已下架', cnt: 1 },
            { name: '电视', state: '销售中', cnt: 1 },
            { name: '相机', state: '已下架', cnt: 2 },
            { name: '华为', state: '销售中', cnt: 3 },
            { name: '小米', state: '销售中', cnt: 2 },
            { name: '苹果', state: '销售中', cnt: 1 },
            { name: '上衣', state: '销售中', cnt: 1 },
            { name: '裤子', state: '已下架', cnt: 1 },
            { name: '回力', state: '已下架', cnt: 1 },
            { name: '回力', state: '销售中', cnt: 2 },
            { name: '耐克', state: '销售中', cnt: 2 },
            { name: '361°', state: '销售中', cnt: 2 },
            { name: '行李箱', state: '已下架', cnt: 1 },
            { name: '手提包', state: '已下架', cnt: 1 },
            { name: '手提包', state: '销售中', cnt: 2 },
            { name: null, state: '已下架', cnt: 1 },
            { name: '耳钉', state: '销售中', cnt: 2 },
          ],
        };
      ...
      day() {
        ...
        const res = {
          ...
          msg: '',
          datas: [
            { time: '2021-07-13', order_cnt: 1, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-07-14', order_cnt: 3, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-07-15', order_cnt: 2, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-07-16', order_cnt: 2, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-07-17', order_cnt: 1, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-07-18', order_cnt: 1, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-07-19', order_cnt: 5, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-07-20', order_cnt: 2, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-07-21', order_cnt: 6, pay_cnt: 1, pay_money: 0.01 },
            { time: '2021-07-22', order_cnt: 3, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-07-23', order_cnt: 3, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-07-24', order_cnt: 3, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-07-25', order_cnt: 3, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-07-26', order_cnt: 3, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-07-27', order_cnt: 3, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-07-28', order_cnt: 3, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-07-29', order_cnt: 3, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-07-30', order_cnt: 3, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-08-01', order_cnt: 3, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-08-02', order_cnt: 3, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-08-03', order_cnt: 3, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-08-04', order_cnt: 3, pay_cnt: 0, pay_money: 0.0 },
          ],
        };
        if (res.code == 200) {
      ...
      month() {
        ...
        const res = {
          ...
          msg: '',
          datas: [
            { time: '2021-07', order_cnt: 1, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-06', order_cnt: 3, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-05', order_cnt: 2, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-04', order_cnt: 2, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-03', order_cnt: 1, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-02', order_cnt: 1, pay_cnt: 0, pay_money: 0.0 },
            { time: '2021-01', order_cnt: 5, pay_cnt: 0, pay_money: 0.0 },
            { time: '2020-12', order_cnt: 2, pay_cnt: 0, pay_money: 0.0 },
            { time: '2020-10', order_cnt: 6, pay_cnt: 1, pay_money: 0.01 },
            { time: '2020-09', order_cnt: 3, pay_cnt: 0, pay_money: 0.0 },
          ],
        };
      ...
      get_visit_stats() {
        const res = {
          ...
          msg: '',
          datas: [
            { goods_id: 1057, name: 'Huawei/华为Mate30 全网通5G智能手机', state: '销售中', visit: 32, browse: 101.0 },
            {
              goods_id: 1061,
            ...
            { goods_id: 1042, name: '上衣衬衫女', state: '销售中', visit: 24, browse: 97.0 },
            { goods_id: 1037, name: '小米电视', state: '销售中', visit: 24, browse: 92.0 },
            { goods_id: 1046, name: '361°篮球鞋', state: '销售中', visit: 24, browse: 126.0 },
            { goods_id: 1035, name: '三星冰箱', state: '销售中', visit: 24, browse: 114.0 },
            { goods_id: 1055, name: '361男鞋运动鞋', state: '销售中', visit: 21, browse: 41.0 },
            { goods_id: 1050, name: '华为荣耀20', state: '销售中', visit: 19, browse: 131.0 },
            { goods_id: 1054, name: '耐克男子运动鞋', state: '销售中', visit: 18, browse: 49.0 },
            { goods_id: 1045, name: 'Nike男鞋', state: '销售中', visit: 17, browse: 36.0 },
            { goods_id: 1041, name: 'iPhone 11 Pro Max', state: '销售中', visit: 14, browse: 68.0 },
            {
              goods_id: 1059,
            ...
            { goods_id: 1039, name: '华为折叠手机', state: '销售中', visit: 14, browse: 116.0 },
            { goods_id: 1043, name: '休闲裤', state: '已下架', visit: 12, browse: 20.0 },
            { goods_id: 1053, name: '回力帆布小白鞋', state: '销售中', visit: 11, browse: 19.0 },
            { goods_id: 1040, name: '小米10', state: '销售中', visit: 11, browse: 28.0 },
            { goods_id: 1051, name: '黑鲨游戏手机', state: '销售中', visit: 11, browse: 69.0 },
            { goods_id: 1056, name: '富士X-T200相机', state: '已下架', visit: 9, browse: 26.0 },
          ],
        };
        if (res.code == 200) {
      ...
      get_browse_stats() {
        const res = {
          ...
          datas: [
            ...
            { goods_id: 1044, name: '回力手绘鞋鲸鱼', state: '销售中', visit: 8, browse: 22.0 },
            { goods_id: 1043, name: '休闲裤', state: '已下架', visit: 12, browse: 20.0 },
          ],
        };
    ...
    created() {
      ...
      this.order_sta = { order_cnt: 162, pay_cnt: 52, pay_money: 0.6, refund_cnt: 4 };
